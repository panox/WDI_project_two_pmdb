...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { country: @director.country, description: @director.description, name: @director.name, picture: @director.picture }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { country: @director.country, description: @director.description, name: @director.name, picture: @director.picture }
    assert_redirected_to director_path(assigns(:director))
  end
